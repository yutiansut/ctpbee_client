...
from .views import LoginView, MarketView, OpenOrderView, StrategyView, AuthCodeView, LogoutView,UserCheckView
...
def init_app():
    ...
    app.add_url_rule("/check_key", view_func=UserCheckView.as_view("check_key"), methods=["POST"])
