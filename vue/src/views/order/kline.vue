...
const ReactKline = {
  ...
  methods: {
    resize(w, h) {
      this.$data.kline.resize(w, h);
    },

    setSymbol(symbol, symbolName) {
      this.$data.kline.setSymbol(symbol, symbolName);
    },

    setTheme(style) {
      this.$data.kline.setTheme(style);
    },

    setLanguage(lang) {
      this.$data.kline.setLanguage(lang);
    },

    setIntervalTime(intervalTime) {
      this.$data.kline.setIntervalTime(intervalTime);
    },
